...
(customize-set-variable
 ...
 `(("." . ,(concat kbr/emacs-directory "backup/files/"))))
...
(customize-set-variable
 ...
 (concat kbr/emacs-directory "backup/auto-saves/saves-"))

(defun kbr/rm-old-backups (age)
...
(kbr/rm-old-backups (days-to-time 30))
